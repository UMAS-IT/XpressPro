...
namespace Orion.Domain.EntityCatalogQuantech
{
    ...
    public class CatalogA4 : Catalog
    {
        ...
        [NotMapped]
        public override string Product { get => "Water Cooled Chillers Factory Lead Time"; }
        [NotMapped]
        public override string Index { get => "a4"; }

        public CatalogA4() : base()
        {
            UnitSize = "";
            Description = "";
            Voltage = "";
