...
{
    public class EditB5CatalogViewModel : BindableBase, IEditCatalogViewModel
    {
        ...
        public EditB5CatalogViewModel(IDialogCoordinator dialogCoordinator, ICatalog catalog)
        {
            Catalog = catalog;
        ...
        {
            CatalogB5 catalog = Catalog as CatalogB5;
