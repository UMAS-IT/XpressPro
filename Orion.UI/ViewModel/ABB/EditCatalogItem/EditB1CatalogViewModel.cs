...
{
    public class EditB1CatalogViewModel : BindableBase, IEditCatalogViewModel
    {
        ...
        public EditB1CatalogViewModel(IDialogCoordinator dialogCoordinator, ICatalog catalog)
        {
            Catalog = catalog;
        ...
        {
            CatalogB1 catalog = Catalog as CatalogB1;
