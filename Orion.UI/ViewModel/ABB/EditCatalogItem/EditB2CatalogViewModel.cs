...
{
    public class EditB2CatalogViewModel : BindableBase, IEditCatalogViewModel
    {
        ...
        public EditB2CatalogViewModel(IDialogCoordinator dialogCoordinator, ICatalog catalog)
        {
            Catalog = catalog;
        ...
        {
            CatalogB2 catalog = Catalog as CatalogB2;
