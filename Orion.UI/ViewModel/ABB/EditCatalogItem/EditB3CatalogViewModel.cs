...
{
    public class EditB3CatalogViewModel : BindableBase, IEditCatalogViewModel
    {
        ...
        public EditB3CatalogViewModel(IDialogCoordinator dialogCoordinator, ICatalog catalog)
        {
            Catalog = catalog;
        ...
        {
            CatalogB3 catalog = Catalog as CatalogB3;
