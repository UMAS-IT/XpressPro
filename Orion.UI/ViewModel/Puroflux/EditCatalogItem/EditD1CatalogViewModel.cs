...
{
    public class EditD1CatalogViewModel : BindableBase, IEditCatalogViewModel
    {
        ...
        public EditD1CatalogViewModel(IDialogCoordinator dialogCoordinator, ICatalog catalog)
        {
            Catalog = catalog;
        ...
        {
            CatalogD1 catalog = Catalog as CatalogD1;
