...
{
    public class EditC1CatalogViewModel : BindableBase, IEditCatalogViewModel
    {
        ...
        public EditC1CatalogViewModel(IDialogCoordinator dialogCoordinator, ICatalog catalog)
        {
            Catalog = catalog;
        ...
        {
            CatalogC1 catalog = Catalog as CatalogC1;
