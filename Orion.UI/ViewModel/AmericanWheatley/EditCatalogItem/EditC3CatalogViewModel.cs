...
{
    public class EditC3CatalogViewModel : BindableBase, IEditCatalogViewModel
    {
        ...
        public EditC3CatalogViewModel(IDialogCoordinator dialogCoordinator, ICatalog catalog)
        {
            Catalog = catalog;
        ...
        {
            CatalogC3 catalog = Catalog as CatalogC3;
