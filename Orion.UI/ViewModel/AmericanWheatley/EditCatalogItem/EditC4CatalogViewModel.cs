...
{
    public class EditC4CatalogViewModel : BindableBase, IEditCatalogViewModel
    {
        ...
        public EditC4CatalogViewModel(IDialogCoordinator dialogCoordinator, ICatalog catalog)
        {
            Catalog = catalog;
        ...
        {
            CatalogC4 catalog = Catalog as CatalogC4;
