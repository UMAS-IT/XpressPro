...
{
    public class EditC2CatalogViewModel : BindableBase, IEditCatalogViewModel
    {
        ...
        public EditC2CatalogViewModel(IDialogCoordinator dialogCoordinator, ICatalog catalog)
        {
            Catalog = catalog;
        ...
        {
            CatalogC2 catalog = Catalog as CatalogC2;
