...
{
    public class EditA3CatalogViewModel : BindableBase, IEditCatalogViewModel
    {
        ...
        public EditA3CatalogViewModel(IDialogCoordinator dialogCoordinator, ICatalog catalog)
        {
            Catalog = catalog;
        ...
        {
            CatalogA3 catalog = Catalog as CatalogA3;
