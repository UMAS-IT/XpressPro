...
{
    public class EditA2CatalogViewModel : BindableBase, IEditCatalogViewModel
    {
        ...
        public EditA2CatalogViewModel(IDialogCoordinator dialogCoordinator, ICatalog catalog)
        {
            Catalog = catalog;
        ...
        {
            CatalogA2 catalog = Catalog as CatalogA2;
