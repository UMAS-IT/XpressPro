...
{
    public class CatalogA2ListViewModel : BindableBase, ICatalogListViewModel
    {
        ...
        public CatalogA2ListViewModel(IDialogCoordinator dialogCoordinator)
        {
        ...
        private async void OnLoadData()
        {
            try
            {
                ...
                Model = "";
                CatalogsBase = catalogService.GetCatalogA2s().OrderByDescending(x => x.Id).ToObservableCollection();
