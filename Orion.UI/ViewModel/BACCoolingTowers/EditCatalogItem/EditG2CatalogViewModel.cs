...
{
    public class EditG2CatalogViewModel : BindableBase, IEditCatalogViewModel
    {
        ...
        public EditG2CatalogViewModel(IDialogCoordinator dialogCoordinator, ICatalog catalog)
        {
            Catalog = catalog;
        ...
        {
            CatalogG2 catalog = Catalog as CatalogG2;
