...
{
    public class EditG3CatalogViewModel : BindableBase, IEditCatalogViewModel
    {
        ...
        public EditG3CatalogViewModel(IDialogCoordinator dialogCoordinator, ICatalog catalog)
        {
            Catalog = catalog;
        ...
        {
            CatalogG3 catalog = Catalog as CatalogG3;
