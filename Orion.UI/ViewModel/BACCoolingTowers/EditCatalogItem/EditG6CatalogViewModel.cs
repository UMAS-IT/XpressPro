...
{
    public class EditG6CatalogViewModel : BindableBase, IEditCatalogViewModel
    {
        ...
        public EditG6CatalogViewModel(IDialogCoordinator dialogCoordinator, ICatalog catalog)
        {
            Catalog = catalog;
        ...
        {
            CatalogG6 catalog = Catalog as CatalogG6;
