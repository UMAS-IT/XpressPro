...
{
    public class EditG5CatalogViewModel : BindableBase, IEditCatalogViewModel
    {
        ...
        public EditG5CatalogViewModel(IDialogCoordinator dialogCoordinator, ICatalog catalog)
        {
            Catalog = catalog;
        ...
        {
            CatalogG5 catalog = Catalog as CatalogG5;
