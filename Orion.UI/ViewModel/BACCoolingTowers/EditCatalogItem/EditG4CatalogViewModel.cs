...
{
    public class EditG4CatalogViewModel : BindableBase, IEditCatalogViewModel
    {
        ...
        public EditG4CatalogViewModel(IDialogCoordinator dialogCoordinator, ICatalog catalog)
        {
            Catalog = catalog;
        ...
        {
            CatalogG4 catalog = Catalog as CatalogG4;
