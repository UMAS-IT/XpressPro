...
{
    public class EditG1CatalogViewModel : BindableBase, IEditCatalogViewModel
    {
        ...
        public EditG1CatalogViewModel(IDialogCoordinator dialogCoordinator, ICatalog catalog)
        {
            Catalog = catalog;
        ...
        {
            CatalogG1 catalog = Catalog as CatalogG1;
