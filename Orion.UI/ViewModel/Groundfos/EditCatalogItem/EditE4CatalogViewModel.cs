...
{
    public class EditE4CatalogViewModel : BindableBase, IEditCatalogViewModel
    {
        ...
        public EditE4CatalogViewModel(IDialogCoordinator dialogCoordinator, ICatalog catalog)
        {
            Catalog = catalog;
        ...
        {
            CatalogE4 catalog = Catalog as CatalogE4;
