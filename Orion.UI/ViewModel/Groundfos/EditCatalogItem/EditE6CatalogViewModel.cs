...
{
    public class EditE6CatalogViewModel : BindableBase, IEditCatalogViewModel
    {
        ...
        public EditE6CatalogViewModel(IDialogCoordinator dialogCoordinator, ICatalog catalog)
        {
            Catalog = catalog;
        ...
        {
            CatalogE6 catalog = Catalog as CatalogE6;
