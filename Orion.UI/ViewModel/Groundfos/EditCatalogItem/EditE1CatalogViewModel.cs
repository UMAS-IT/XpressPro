...
{
    public class EditE1CatalogViewModel : BindableBase, IEditCatalogViewModel
    {
        ...
        public EditE1CatalogViewModel(IDialogCoordinator dialogCoordinator, ICatalog catalog)
        {
            Catalog = catalog;
        ...
        {
            CatalogE1 catalog = Catalog as CatalogE1;
