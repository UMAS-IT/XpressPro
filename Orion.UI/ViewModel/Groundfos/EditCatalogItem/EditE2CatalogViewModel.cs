...
{
    public class EditE2CatalogViewModel : BindableBase, IEditCatalogViewModel
    {
        ...
        public EditE2CatalogViewModel(IDialogCoordinator dialogCoordinator, ICatalog catalog)
        {
            Catalog = catalog;
        ...
        {
            CatalogE2 catalog = Catalog as CatalogE2;
