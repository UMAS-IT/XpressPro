...
{
    public class EditE7CatalogViewModel : BindableBase, IEditCatalogViewModel
    {
        ...
        public EditE7CatalogViewModel(IDialogCoordinator dialogCoordinator, ICatalog catalog)
        {
            Catalog = catalog;
        ...
        {
            CatalogE7 catalog = Catalog as CatalogE7;
