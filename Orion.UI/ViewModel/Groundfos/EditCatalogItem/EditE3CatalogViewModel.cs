...
{
    public class EditE3CatalogViewModel : BindableBase, IEditCatalogViewModel
    {
        ...
        public EditE3CatalogViewModel(IDialogCoordinator dialogCoordinator, ICatalog catalog)
        {
            Catalog = catalog;
        ...
        {
            CatalogE3 catalog = Catalog as CatalogE3;
