...
{
    public class EditE5CatalogViewModel : BindableBase, IEditCatalogViewModel
    {
        ...
        public EditE5CatalogViewModel(IDialogCoordinator dialogCoordinator, ICatalog catalog)
        {
            Catalog = catalog;
        ...
        {
            CatalogE5 catalog = Catalog as CatalogE5;
