...
{
    public class EditH1CatalogViewModel : BindableBase, IEditCatalogViewModel
    {
        ...
        public EditH1CatalogViewModel(IDialogCoordinator dialogCoordinator, ICatalog catalog)
        {
            Catalog = catalog;
        ...
        {
            CatalogH1 catalog = Catalog as CatalogH1;
