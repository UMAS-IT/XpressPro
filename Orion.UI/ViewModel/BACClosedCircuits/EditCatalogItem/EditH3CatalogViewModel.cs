...
{
    public class EditH3CatalogViewModel : BindableBase, IEditCatalogViewModel
    {
        ...
        public EditH3CatalogViewModel(IDialogCoordinator dialogCoordinator, ICatalog catalog)
        {
            Catalog = catalog;
        ...
        {
            CatalogH3 catalog = Catalog as CatalogH3;
