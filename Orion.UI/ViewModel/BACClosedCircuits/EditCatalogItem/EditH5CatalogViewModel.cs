...
{
    public class EditH5CatalogViewModel : BindableBase, IEditCatalogViewModel
    {
        ...
        public EditH5CatalogViewModel(IDialogCoordinator dialogCoordinator, ICatalog catalog)
        {
            Catalog = catalog;
        ...
        {
            CatalogH5 catalog = Catalog as CatalogH5;
