...
{
    public class EditH4CatalogViewModel : BindableBase, IEditCatalogViewModel
    {
        ...
        public EditH4CatalogViewModel(IDialogCoordinator dialogCoordinator, ICatalog catalog)
        {
            Catalog = catalog;
        ...
        {
            CatalogH4 catalog = Catalog as CatalogH4;
