...
{
    public class EditH2CatalogViewModel : BindableBase, IEditCatalogViewModel
    {
        ...
        public EditH2CatalogViewModel(IDialogCoordinator dialogCoordinator, ICatalog catalog)
        {
            Catalog = catalog;
        ...
        {
            CatalogH2 catalog = Catalog as CatalogH2;
